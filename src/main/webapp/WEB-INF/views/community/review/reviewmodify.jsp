    ...
    <div class="container-fluid">
        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <ul class="navbar-nav bg-light">
                ...
                <li class="nav-item">
                    <c:url var="reviewdetailPage" value="/community/review/reviewdetail">
                        <c:param name="id" value="${ post.id }"></c:param>
                    </c:url>
                    <a class="nav-link" href="${ reviewdetailPage }">상세보기</a>
                </li>
            </ul>
        </nav>
        ...
        <script src="../../static/js/review-modify.js"></script>
    </div>
    </body>
</html>
