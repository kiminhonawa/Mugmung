   ...
   <div class="col-md-7 col-lg-8">
    ...
    <!-- 문의하기 -->
      <div class="form-group col-md-6">
       <label for="inquiry" class="form-label">문의구분</label> 
    ...
    <div class="col-md-10">
        ...
        <p class="text_bit">(<span data-text-length>0</span>/1000자)</p>
    </div>
    ...
    <dt>첨부파일</dt>
      <dd>
        ...
        <ul class="list_type">
          <li>최대 5MB / 최대 5개까지 첨부 가능 / 첨부 가능 파일 : PNG, JPG, JPEG, XLS, XLSX, PDF</li>
        </ul>
      </dd>
    ...
    <br>
      <dl>
        <dt><label class="est">판매업체명</label></dt>
        <dd>
          <div class="input_area">
            <input type="text" class="form-control" maxlength="20" data-role="companyNm" />
          </div>
        </dd>
        <dt><label class="est">담당자 이름</label></dt>
        <dd>
          <div class="input_area">
            <input type="text" class="form-control" data-role="managerNm" maxlength="20" />
          </div>
        </dd>
        <dt><label class="est">담당자 휴대폰</label></dt>
        <dd>
          <div class="input_area" data-input="cellphone">
            <input type="text" class="form-control" maxlength="13" data-role="managerMobile" id="cellphone"
              placeholder="- 없이 입력" />
          </div>
        </dd>
        <dt><span class="est">담당자 이메일</span></dt>
        <dd>
          <div class="input_area" data-input="email">
            <input type="text" class="form-control" maxlength="30" data-role="managerEmail" id="email"
        ...
        <dd>
          <div class="input_area">
            <input type="text" class="form-control" data-role="homepageUrl" maxlength="200" />
          </div>
        </dd>
      </dl>
      
         <button class="w-100 btn btn-primary btn-lg" type="submit" value="작성 완료" 
                id="btnInquiry">문의하기</button>
    </form>    
