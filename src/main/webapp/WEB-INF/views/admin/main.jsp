		...
		<main>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-2" style="padding-left: 0; width: 150px;">
						<div class="sidebar">
							<ul class="nav flex-column">
								...
								<li class="nav-item"><a href="${adminNoticePage}"
									class="nav-link">공지사항</a></li>
								<li class="nav-item"><c:url var="storecreatePage"
										value="/admin/storecreate" /> <a class="nav-link"
									href="${ storecreatePage }">새 매장 등록</a> <a class="nav-link"
									href="/mugmung/admin/main">매장 정보</a></li>

								<c:url var="adminReviewPage" value="/admin/main/review" />
								<li class="nav-item"><a href="${adminReviewPage}"
					...
					<div class="col-md-5">
						<div>
							<canvas id="ageChart" width="350" height="350"></canvas>
							<!-- 바 차트를 표시할 canvas 요소 -->
						</div>
					</div>
					<div class="col-md-5">
